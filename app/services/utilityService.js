...
var _cw;
    ...
    // Inject
    UtilityService.$inject = ['QlikAppConfig'];
    ...
    // Construct
    function UtilityService(QlikAppConfig) {
        /**
         * UtilityService
         *
        ...
        function getFieldGroup(fieldGroupName) {
            ...
            QlikAppConfig.fieldGroups[fieldGroupName].forEach(fieldName => {
                
                // Get field object
                var field = QlikAppConfig.fields.find(x => { return x.name == fieldName; })
        ...
        // Log
        console.log('Constructed UtilityService!', cw(), self);
    }
