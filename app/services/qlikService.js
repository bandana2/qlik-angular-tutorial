    ...
    // Inject
    QlikService.$inject = ['$timeout', 'qlik', 'QlikAppConfig', 'UtilityService'];
    
    
    // Construct
    function QlikService($timeout, qlik, QlikAppConfig, UtilityService) {
        /**
         * QlikService
         *
        ...
        var self = this;
        self.qlik = qlik;
        self.app = qlik.openApp(QlikAppConfig.app, config); // TODO:  Remove global 'config' variable?
